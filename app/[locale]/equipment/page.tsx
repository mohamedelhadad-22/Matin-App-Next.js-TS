...
export default async function EquipmentPage() {
    const t = await getTranslations('Sidebar'); // Just using sidebar keys for now as generic title
    ...
    return (
        <div className="container mx-auto py-10">
            ...
            <div className="flex justify-between items-center mb-8">
                ...
                <button className="bg-matin-primary text-white px-4 py-2 rounded-lg hover:bg-opacity-90 transition shadow-sm">
                    + Add Equipment
                </button>
            </div>
